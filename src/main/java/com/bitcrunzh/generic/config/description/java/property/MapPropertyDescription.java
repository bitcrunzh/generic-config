...
public class MapPropertyDescription<C, K, V> extends PropertyDescriptionBase<C, Map<K, V>> {
    ...
    public MapPropertyDescription(String propertyName, String fieldName, String description, Map<K, V> defaultValue, Class<C> parentType, Class<Map<K, V>> type, PropertyValidator<Map<K, V>>validator, CollectionValueDescription<K> mapKeyDescription, CollectionValueDescription<V> mapValueDescription, boolean isOptional, Version introducedInVersion, Function<C, Map<K, V>> getterFunction, ClassDescriptionCache classDescriptionCache) {
        this(propertyName, fieldName, description, defaultValue, parentType, type, validator, mapKeyDescription, mapValueDescription, isOptional, introducedInVersion, getterFunction, null, classDescriptionCache);
    }

    public MapPropertyDescription(String propertyName, String fieldName, String description, Map<K, V> defaultValue, Class<C> parentType, Class<Map<K, V>> type, PropertyValidator<Map<K, V>> validator, CollectionValueDescription<K> mapKeyDescription, CollectionValueDescription<V> mapValueDescription, boolean isOptional, Version introducedInVersion, Function<C, Map<K, V>> getterFunction, BiConsumer<C, Map<K, V>> setterFunction, ClassDescriptionCache classDescriptionCache) {
        super(propertyName, fieldName, description, defaultValue, parentType, type, validator, isOptional, introducedInVersion, getterFunction, setterFunction);
